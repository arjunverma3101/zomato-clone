    ...
    return (
        <>
            <div className="w-full flex rounded-xl hover:shadow-lg hover:shadow-gray-500 md:flex-row flex-col md:gap-0 gap-4 md:pb-0 pb-6">
                <div className="lg:w-60 md:w-[13rem]">
                    <img className="md:rounded-tr-none  md:rounded-l-lg  rounded-t-xl w-full" src="https://b.zmtcdn.com/data/pictures/chains/3/53923/f1ed8209bf84106c577ebd774dd7194b_o2_featured_v2.jpg" />
                </div>
                <div className="lg:w-[75%] md:w-[70%] px-4 flex flex-col justify-evenly gap-1">
